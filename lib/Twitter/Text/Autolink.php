...
class Autolink extends Regex
{
    ...
    public function addLinksToHashtags($loose = false)
    {
        ...
        return preg_replace_callback(self::$patterns['valid_hashtag'], array($this, '_addLinksToHashtags'), $this->tweet);
    }
    ...
    public function addLinksToCashtags($loose = false)
    {
        ...
        return preg_replace_callback(self::$patterns['valid_cashtag'], array($this, '_addLinksToCashtags'), $this->tweet);
    }
    ...
    public function addLinksToUsernamesAndLists($loose = false)
    {
        ...
        return preg_replace_callback(self::$patterns['valid_mentions_or_lists'], array($this, '_addLinksToUsernamesAndLists'), $this->tweet);
    }
    ...
    protected function _addLinksToHashtags($matches)
    {
        ...
        if (preg_match(self::$patterns['end_hashtag_match'], $after) || (!preg_match('!\A["\']!', $before) && preg_match('!\A["\']!', $after)) || preg_match('!\A</!', $after)) {
            return $all;
        }
        $replacement = $before;
        $element = $hash . $tag;
